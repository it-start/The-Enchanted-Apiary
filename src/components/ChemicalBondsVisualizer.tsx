...
export const ChemicalBondsVisualizer: React.FC<ChemicalBondsVisualizerProps> = ({
  ...
  const atoms = HIVE_ELEMENTS.map(el => {
    ...
    return {
      ...
      role: el.chemistryRole, // role is short, maybe keep English or translate if needed
      chemistry: t(`elements.${el.id}.chemistry`),
      desc: t(`elements.${el.id}.detailedDescription`),
