  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-8 lg:p-12">
      <div className="text-center mb-12">
        <h3 className="text-3xl serif font-bold text-slate-900 mb-4">The Metamorphosis of Code</h3>
        <p className="text-slate-600 max-w-2xl mx-auto">
          In the Hive, software is not "built" in a factory; it is "grown" organically. 
          Every component follows the sacred biological lifecycle.
        </p>
      </div>
              ...
              >
                ...
                <div className={`p-6 rounded-2xl border transition-all duration-500 h-full ${
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold uppercase tracking-widest text-slate-500">{stage.name}</span>
                    <span className="text-xs font-mono bg-white px-2 py-1 rounded border border-stone-200 text-slate-600">{stage.techConfig}</span>
                  </div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">{stage.metaphor}</h4>
      ...
      <div className="mt-12 text-center">
        ...
        >
          Evolve Component <ArrowRight size={16} />
        </button>
      </div>
    </div>
  );
