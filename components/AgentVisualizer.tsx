      ...
      <div className="w-full lg:w-1/3 space-y-6">
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-stone-200">
          <div className="flex items-center gap-3 mb-4 text-slate-800">
            ...
            <h3 className="text-xl font-serif font-bold">Hive Mind Agent</h3>
          </div>
          <p className="text-slate-600 text-sm mb-6">
            An autonomous "Queen Bee" agent. It receives a goal and recursively calls tools until the goal is satisfied.
          </p>
          
          <div className="space-y-4">
            <label className="text-xs font-bold uppercase tracking-widest text-slate-400">Mission Objective</label>
            <textarea 
              value={prompt}
            ...
            >
              ...
              {isThinking ? 'Processing...' : 'Execute Agent Loop'}
            </button>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-2xl p-6 border border-stone-200">
          <div className="flex items-center gap-2 mb-4 text-slate-700">
            <Hammer size={18} />
            <h4 className="font-bold text-sm">Available Tools (Functions)</h4>
          </div>
