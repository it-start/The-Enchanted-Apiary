...
export const Navbar: React.FC = () => {
  ...
  const links = [
    ...
    { name: 'The ATCG Code', href: '#atcg' },
    { name: 'Chemistry', href: '#chemistry' },
    { name: 'Sacred Patterns', href: '#patterns' },
    { name: 'Dynamics', href: '#dynamics' },
    { name: 'Immune System', href: '#immune' },
  ];

  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-stone-200 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center gap-2 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            ...
            <span className="font-serif font-bold text-xl text-slate-900 tracking-tight">{APP_METADATA.subtitle}</span>
          </div>
